...
{
    [Fact]
    public void MaskIdentifier_ReturnsMasked_WhenNoPermission()
    {
        ...
        var result = service.MaskIdentifier("john@example.com");

        Assert.Equal("***", result);
    }

    [Fact]
    public void MaskIdentifier_ReturnsOriginal_WhenHasPermission()
    {
        var permService = Substitute.For<IPermissionService>();
